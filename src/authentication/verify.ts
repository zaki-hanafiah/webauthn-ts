...
export function verify(
    ...
    // Step 14:  Verify that AuthenticatorData has the userVerified bit set to 1. This is only necessary when the registration requires prior user authentication (which is the case most times).
    // userVerified is encoded on the third bit, meaning xxxxx1xx AND 00000100 must be at least 4.
