...
export declare function PackedVerify(attestation: GenericAttestation, attStmt: PackedStmt, clientDataHash: Buffer, authenticatorData: AuthenticatorData): boolean;
