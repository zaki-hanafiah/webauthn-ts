...
exports.router.get('/creationOptions', (req, res) => {
    res.send(JSON.stringify((0, util_1.generatePublicKeyCredentialCreationOptions)()));
});
exports.router.get('/requestOptions', (req, res) => {
    res.send(JSON.stringify((0, util_1.generatePublicKeyCredentialRequestOptions)(req.cookies.userId)));
});
